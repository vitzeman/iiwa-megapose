...
#TODO: Add argparser so it is possible to run this script from the terminal
...
def manual_icp(goal_path: str, input_path: str) -> None:  # Fill here what to return
    ...
    threshold = 20  # 1cm distance threshold
    ...
    return np.array(reg_p2p.transformation).tolist()
...
if __name__ == "__main__":
    ...
    input_mesh_path = (
        "/home/testbed/Projects/mesh_manipulation/data/reconstruction/bakedsdf/meshes_cleared_scaled/"+ item + "/mesh.obj"
    )
    # input_mesh_path = ("/home/testbed/Projects/CADmodels/obj/Axle_Front.obj")
    target_mesh_path = (
        "/home/testbed/Projects/mesh_manipulation/data/reconstruction/"+method+"/meshes_cleared_scaled/"
        + item
        + "/mesh.obj"
    )
    # target_mesh_path = ("/home/testbed/Projects/mesh_manipulation/data/reconstruction/"+ method +"/meshes_cleared_scaled/"+ item + "/mesh.obj")
    transformation = manual_icp(target_mesh_path, input_mesh_path)
