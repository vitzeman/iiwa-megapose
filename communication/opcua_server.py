...
def check_ready():
    ready_request = KUKA_CONTROLLER_IP + b'ready/'
...
def check_fail():
    fail_request = KUKA_CONTROLLER_IP + b'failed/'
...
if __name__ == "__main__":
    ...
    print(f"Namespace {uri} has idx: ", idx)
