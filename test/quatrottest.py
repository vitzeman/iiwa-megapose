import numpy as np
from Helper.rotation_helper import rotation_angles, rotation_matrix
import math
...
if __name__ == '__main__':
    ...
    quat = rotmat2qvec(Rot)
    a, b,c = euler_from_quaternion(quat[1], quat[2], quat[3],quat[0])
    a1, b1, c1 = euler_from_quaternion(-quat[1], -quat[2], -quat[3],-quat[0])
    print(math.degrees(a),math.degrees(b),math.degrees(c))
    print(math.degrees(a1),math.degrees(b1),math.degrees(c1))
    # A1, B1, C1 = rotation_angles(R1, 'zyx')
    # A2, B2, C2 = rotation_angles(R2, 'zyx')
    #
    # print(A1, B1, C1)
    # print(A2, B2, C2)
